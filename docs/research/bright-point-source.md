...
| **Vangorp 2015 local adaptation** (paper; original code BLOCKED; HDR-VDP-3 descendant with a different σ, 0.165° vs the paper's 0.131°) | GSF/OTF (Deeley / CIE 135) on the physical image → retinal image | **before: glare feeds adaptation** | no TM in the model | preserved | yes | not pupil (their fit) | n/a | n/a (visibility, not brightness) | no | no clipping |
