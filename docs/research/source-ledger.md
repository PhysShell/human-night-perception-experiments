...
| R23 | Shielded lamp (lower-hemisphere emitter at 2× radiance): side-on intensity / full sphere = 1.002; from above = 0.000 | `m2/check_shielded_lamp.py`, `m2/shielded_lamp_check.txt` | H |
