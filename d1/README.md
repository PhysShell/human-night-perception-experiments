...
- [ ] D1 open, in order: display realisation (chroma-priority Y_max(u′v′_B), R1 Y-priority as control) → P-4 v2 (reference L_eff) + R3 (N/A + flat-field guard) → final corpus acceptance
