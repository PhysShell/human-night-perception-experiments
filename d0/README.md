...
**D0 + D0.1 are frozen.** Implementation/documentation mismatch filed for the upstream backlog (draft, not sent): `docs/upstream/pfstools-mantiuk08-display-size/`. The low-light appearance question continues in `d1/README.md`. Still excluded: a custom objective, Spencer/Temporal Glare, Blender changes.
